-- Add "breathing_exercises" to the category CHECK constraint and add language column
...
CHECK (category IN ('motivation', 'coping_strategies', 'educational', 'mindfulness', 'breathing_exercises'));
