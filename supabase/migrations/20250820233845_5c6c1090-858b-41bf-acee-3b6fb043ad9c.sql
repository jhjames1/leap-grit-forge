-- Fix the start_chat_session_atomic function to properly handle session_record initialization
...
BEGIN
  -- Initialize session_record to NULL
  session_record := NULL;
  ...
  IF session_record IS NOT NULL AND 
