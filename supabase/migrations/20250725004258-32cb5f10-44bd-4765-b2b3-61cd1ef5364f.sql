...
BEGIN
  ...
  LOOP
    ...
    AND scheduled_start <= current_time_ts
    AND scheduled_end > current_time_ts;
    ...
    AND start_time <= current_time_ts
    AND end_time > current_time_ts;
    ...
    AND scheduled_start > current_time_ts
    AND scheduled_start <= current_time_ts + interval '15 minutes';
