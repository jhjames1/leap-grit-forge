...
-- Insert some sample specialists for testing
INSERT INTO public.peer_specialists (user_id, first_name, last_name, bio, specialties, years_experience, is_verified, is_active) VALUES
('00000000-0000-0000-0000-000000000001', 'Sarah', 'Johnson', 'Certified peer recovery specialist with experience in addiction recovery and mental health support.', ARRAY['addiction recovery', 'anxiety', 'depression'], 5, true, true),
('00000000-0000-0000-0000-000000000002', 'Mike', 'Chen', 'Former military veteran specializing in PTSD and trauma recovery.', ARRAY['PTSD', 'trauma', 'military transition'], 7, true, true),
('00000000-0000-0000-0000-000000000003', 'Lisa', 'Rodriguez', 'Recovery advocate focused on helping others navigate early recovery challenges.', ARRAY['early recovery', 'relapse prevention', 'family support'], 3, true, true);

-- Insert corresponding status records
INSERT INTO public.specialist_status (specialist_id, status, status_message) VALUES
((SELECT id FROM public.peer_specialists WHERE first_name = 'Sarah'), 'online', 'Available for chat'),
((SELECT id FROM public.peer_specialists WHERE first_name = 'Mike'), 'away', 'Back in 15 minutes'),
((SELECT id FROM public.peer_specialists WHERE first_name = 'Lisa'), 'offline', null);