  ...
  return <div className="flex flex-col h-screen bg-background pb-24">
      ...
      {session && !isSessionEnded && <div className="px-4 py-2">
          <div className="flex space-x-2 overflow-x-auto">
            <Button size="sm" onClick={() => handleQuickAction('need-support')} className="font-fjalla text-xs font-light text-zinc-50 bg-zinc-600 hover:bg-zinc-500 text-center leading-tight h-auto py-2 px-3">
              NEED SUPPORT
            </Button>
